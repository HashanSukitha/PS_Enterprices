...
function ItemReturnedSMS($ContrNo,$con5)
{
	$tp='';
	...
	//$user = "94776629914";
	//$password = "1529";
	//$text = urlencode("Dear Valued Customer , Thank You for Returning Items on Contract Numner --".$ContrNo."--  (PS Ekamuthu Enterprices)");
	//$to = $tp;//"94776629914";//$tp;//"94783497220";

...
function SaveItem()
{
	...
	//var ItmQty = $("input#ITMQTY").val();
			...
			var dataString ='itmCatCode='+itmCatCode+'&itmCode='+itmCode+'&ItmName='+ItmName+'&size='+size+'&itmDlyChg='+itmDlyChg+'&itmDlyDpst='+itmDlyDpst+'&itmMnlyChg='+itmMnlyChg+'&itmMnlyDpst='+itmMnlyDpst+'&itmVal='+itmVal+'&itmType='+itmType+'&itmQty='+itmQty;
				 ...
				 $.ajax({
						type: "POST",
						url: "phpFunctions/createItem.php", 
						data: dataString,
						cache: false,
						success: function(result)
								{
									...
									if (confirm('Do you want to Continue?'))
									{
										LoadStaus1="";
										LoadStaus2="";
										$( "#container" ).load( "Hire_Items.php" );
									} 
									else 
									{
										$( "#container" ).load( "Add_Item.php" );
									}
